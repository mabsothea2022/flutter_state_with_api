...
RadomUserModel radomUserModelFromMap(String str) => RadomUserModel.fromMap(json.decode(str));

String radomUserModelToMap(RadomUserModel data) => json.encode(data.toMap());

class RadomUserModel {
    ...
    factory RadomUserModel.fromMap(Map<String, dynamic> json) => RadomUserModel(
